...
### Documento en `vehiculos` (Ej: Auto Registrado)
```json
{
  "marca": "Kia",
  "patente": "ABCD34",
  "categoria": "AUTO",
  "fecha_ingreso": "11/05/2026",
  "id_usuario": "Reference(/usuarios/RbqHThICVsg3h...)"
}
```

### Documento en `users/{uid}/trips` (Ej: Historial de Viaje)
```json
{
  "date": "11/05/2026 11:43",
  "vehicleName": "Kia (ABBD23)",
  "totalCost": 3138.0,
  "distanceKm": 34.8,
  "duration": "28 min",
  "tolls": [
    {"name": "Pórtico 1", "cost": 645.0, "timestamp": "11:40"},
    {"name": "Pórtico 2", "cost": 412.0, "timestamp": "11:42"}
  ]
}
```
